...
Reliable, high-speed internet access is an essential resource for today's college works and studies, where assignments, entertainment, socialization, and more has been migrated to online platforms such as Moodle and Google services. Yet not all students enjoy equal access to robust networks on Augustana College campuses. This inequality manifests itself in WI-Fi infrastructure quality at academic buildings on campus. Through a comparative analysis of WI-Fi speeds conducted between only two locations, our project aimed to test our claim about the inequality of the WI-fi speed in science and humanities buildings.
